...
/**
 * Vue qui gère l'affichage des utilisateurs et des messages dans un format distinct.
 */
public class JfxView2 implements InterfaceView, InterfaceObservateur {
     ...
     */
    public JfxView2(final Stage stage, final int width, final int height,
    ...
    private void createUsersPanes(final List<InterfaceUser> listUsers) {
        ...
        for (InterfaceUser u : listUsers) {
            ...
            strategyComboBox.setMaxWidth(50);
     ...
     * 
     * @param messagesData Les données des messages.
     * @param user L'utilisateur dont afficher les messages.
     */
     ...
     * 
     * @param u L'utilisateur pour lequel créer le widget.
    ...
    /**
     * Met à jour la liste des messages pour tous les utilisateurs.
     * 
     * @param m Les données des messages.
     * @param u La liste des utilisateurs.
     */
