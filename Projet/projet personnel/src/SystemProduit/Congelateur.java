...
public class Congelateur extends Electrominage{

    public Congelateur(String nom, String referonce, String descriptif, ArrayList<String> ensembleCaracteristiques,
