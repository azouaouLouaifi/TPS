...
public class StationDeTravil extends Informatique {

    public StationDeTravil(String nom, String referonce, String descriptif, ArrayList<String> ensembleCaracteristiques,
