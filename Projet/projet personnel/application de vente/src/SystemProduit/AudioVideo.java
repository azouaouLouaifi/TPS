...
public class AudioVideo extends Electrionique {

    public AudioVideo(String nom, String referonce, String descriptif, ArrayList<String> ensembleCaracteristiques,
