	  ...
	  public static objet[] convertire_tab_obj(String filePath) {
	        ...
	        try {
	            ...
	            while (scanner.hasNextLine()) {
	                ...
	                int i1 = Integer.parseInt(parts[1].substring(1)); 
	                int poid = Integer.parseInt(parts[3]);
	                int valeur = Integer.parseInt(parts[5]);
	                
	                objet objet = new objet(valeur, poid,i1);
	                objets.add(objet);
	            }
	      ...
	      /*  try {
	        ...
	        try {
	            ...
	            while (scanner.hasNextLine()) {
	                ...
	                int poid = Integer.parseInt(parts[3]);
	                int valeur = Integer.parseInt(parts[5]);
	                Sacàdos sac = new Sacàdos(poid,valeur, 0, 0, tab_init_0); // Assurez-vous d'avoir tab_init_0 initialisé
	                sacsList.add(sac);
	            }
