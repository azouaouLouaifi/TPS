...
public class GeneticAlgo2 {
	 ...
	 */
	 ...
	 public sol[] verifierfitness(sol [] pop, int l) {
           if(pop[l-1].fitness==pop[l].fitness) {
        	   if(pop[l-1].poid_total>pop[l].poid_total) {
        		   sol temp =pop[l-1];
        		   pop[l-1]=pop[l];
        		   pop[l]=temp;
        	   }
...
//********************************************************************************************************
	...
	//********************************************************************************************************							
	 ...
	 public sol[] croisement2 (sol[] pop,float r) {
			return pop;
		}
	 public sol[] mutation(sol[] croisement,float rate) {
		 ...
		 if(nbrmutation<croisement.length) {
	 ...
	 public typeretourga genetique_algo(int maxgen,int nbr_pop,Sacàdos[] sacs, objet[] objets) {
		...
		for(int i=0;i<maxgen;i++) {
			    ...
			    sol [] enfantC=croisement2(pop,ratec);
	  ...
	  double tempsEcouleEnSecondes = duration / 1_000_000_000.0; 
		...
		/*for(Sac s :pop[0].sacs) {
			...
			//	System.out.print("num objet: "+o.num+" poids objet : "+o.poids+"val objet :"+o.valeur);
				System.out.print("num:  "+o.num+" p : "+o.poids+"v :"+o.valeur);
		...
		System.out.println("init sol   :  p:"+pop[0].poid_total+" v:"+pop[0].valeur_total);
